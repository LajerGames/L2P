...
->Set('song_generator_duration', 'Duration')
->Set('song_generator_duration_short', 'Short')
->Set('song_generator_duration_medium', 'Medium')
->Set('song_generator_duration_long', 'Long')
->Set('song_generator_speed', 'Speed')
->Set('song_generator_speed_slow', 'Slow')
->Set('song_generator_speed_medium', 'Medium')
->Set('song_generator_speed_fast', 'Fast')
->Set('song_generator_pulse', 'Pulse')
->Set('song_generator_difficulty', 'Difficulty')
->Set('song_generator_difficulty_easy', 'Easy')
->Set('song_generator_difficulty_medium', 'Medium')
->Set('song_generator_difficulty_hard', 'Hard')
->Set('song_generator_note_lowest', 'Lowest note')
->Set('song_generator_note_highest', 'Highest note')
->Set('song_generator_octave_lowest', 'Lowest octave')
...
->Set('key_c_major', 'C-major')
->Set('key_a_minor', 'A-minor')
->Set('key_g_major', 'G-major')
->Set('key_e_minor', 'E-minor')
->Set('key_d_major', 'D-major')
->Set('key_b_minor', 'B-minor')
->Set('key_a_major', 'A-major')
->Set('key_f_sharp_minor', 'F#-minor')
->Set('key_e_major', 'E-major')
->Set('key_c_sharp_minor', 'C#-minor')
->Set('key_b_major', 'B-major')
->Set('key_g_sharp_minor', 'G#-minor')
->Set('key_f_sharp_major', 'F#-major')
->Set('key_d_sharp_minor', 'D#-minor')
->Set('key_g_flat_major', 'Gb-major')
->Set('key_e_flat_minor', 'Eb-minor')
->Set('key_d_flat_major', 'Db-major')
->Set('key_b_flat_minor', 'Bb-minor')
->Set('key_a_flat_major', 'Ab-major')
->Set('key_f_minor', 'F-minor')
->Set('key_e_flat_major', 'Eb-major')
->Set('key_c_minor', 'C-minor')
->Set('key_b_flat_major', 'Bb-major')
->Set('key_g_minor', 'G-minor')
->Set('key_f_major', 'F-major')
->Set('key_d_minor', 'D-minor')
...
->Set('2_0', 'Click "1st position scales" to show all available scales.')
...
->Set('4_0', 'Please make some noise, so we can test our access to your microphone.<span style="display: none;"><br><br><strong>We have not heard your noise yet, please check that your mircophone works</strong></span>')
