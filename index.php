...
switch($_REQUEST['mode']) // Yep it makes sence to use request here!
{
	...
	case 'game_create':
	    ...
	    $oGameCreateForm->TextField('dk_title', '', $oLang->Get('game_create_dktitle'), new FormFieldValidation(true, PATTERN_TITLE_SPACE, $oLang->Get('game_create_validation_title'), false), null, false, array('maxlength' => 30));
	    $oGameCreateForm->TextField('en_title', '', $oLang->Get('game_create_entitle'), new FormFieldValidation(true, PATTERN_TITLE_SPACE, $oLang->Get('game_create_validation_title'), false), null, false, array('maxlength' => 30));
	    ...
	    $oGameCreateForm->SelectBox('status', '', $arrStatus, $oLang->Get('game_create_status'));
